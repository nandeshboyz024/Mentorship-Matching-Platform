  ...
  return (
    <div className="dashboard-container">      
      ...
      <div className="main-content">
        ...
        <ToastContainer/>
        <section style={{ flex: 1, marginLeft: '20px', backgroundColor: '#fff', padding: '20px', borderRadius: '10px', boxShadow: '0px 4px 12px rgba(0, 0, 0, 0.1)' }}>
          <div style={{ marginBottom: '15px', paddingBottom: '10px', borderBottom: '1px solid #ddd' }}>
            <h4 style={{ color: 'green', marginBottom: '5px' }}>@{user.username} ({user.first_name} {user.last_name} as {user.role === 'mentee' ? 'mentee' : 'mentor'})</h4>
            <h5 style={{ color: '#7f8000', marginBottom: '10px' }}>Email: {user.email}</h5>
          </div>
          <div style={{ marginBottom: '15px', paddingBottom: '10px', borderBottom: '1px solid #ddd' }}>
